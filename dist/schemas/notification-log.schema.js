...
__decorate([
    (0, mongoose_1.Prop)({ enum: ['marketing', 'newsletter', 'updates'], required: true }),
    __metadata("design:type", String)
], NotificationLog.prototype, "type", void 0);
__decorate([
    (0, mongoose_1.Prop)({ enum: ['email', 'sms', 'push'], required: true }),
    __metadata("design:type", String)
], NotificationLog.prototype, "channel", void 0);
__decorate([
    (0, mongoose_1.Prop)({ enum: ['pending', 'sent', 'failed'], required: true }),
    __metadata("design:type", String)
